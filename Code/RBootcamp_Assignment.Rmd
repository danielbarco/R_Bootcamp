...
use_python("/Users/nijeri/dlv/bin/python3.7") #since the default version of python in mac os is python 2. it is necessary
...
Unlike most other scores, R^2 score may be negative (it need not actually be the square of a quantity R). source(https://scikit-learn.org/stable/modules/generated/sklearn.metrics.r2_score.html)
