...
ts$isferiengr = factor(ts$isferiengr, levels = c(unique(ts$isferiengr)), labels = c(0, 1))
ts$isferiensg = factor(ts$isferiensg, levels = c(unique(ts$isferiensg)), labels= c(0, 1))
ts$isferienzh = factor(ts$isferienzh, levels = c(unique(ts$isferienzh)), labels= c(0, 1))
ts$isfeiertag_gr = factor(ts$isfeiertag_gr, levels = c(unique(ts$isfeiertag_gr)), labels= c(0, 1))
ts$isfeiertag_sg = factor(ts$isfeiertag_sg, levels = c(unique(ts$isfeiertag_sg)), labels = c(0, 1))
ts$isfeiertag_zh = factor(ts$isfeiertag_zh, levels = c(unique(ts$isfeiertag_zh)), labels= c(0, 1))
